...
public class ProductGroupMaintenanceAddEditProducts  extends ETHOSDomainWraper {
	...
	public void verifyAddNewProducts(String item) throws InterruptedException, ErrorPageException {
		
		try {
			navigateToProductGroup(driver, "ELE", "Products");
			...
			safeSelectByText(driver, By.id("ctl00_cphMainContent_ddlDataGroupingLevel"),"Delivery Point");
	...
	@Test(dataProvider = "ProductGroupList", dependsOnMethods = {"verifyAddNewProducts"})
	public void verifyEditProducts(String item) throws InterruptedException, ErrorPageException {
		
		try {
			navigateToProductGroup(driver, "ELE", "Products");
			
			int row = returnRowNumber(driver, "#ctl00_cphMainContent_gvProduct>tbody", "AUTO", 2);
			String cssId = "#ctl00_cphMainContent_gvProduct>tbody>tr:nth-child("+row+")>td>a";
	...
	@Test(dataProvider = "ProductGroupList", dependsOnMethods = {"verifyEditProducts"})
	public void verifyDeleteProducts(String item) throws InterruptedException, ErrorPageException {
		
		try {
			navigateToProductGroup(driver, "ELE", "Products");
			
			int row = returnRowNumber(driver, "#ctl00_cphMainContent_gvProduct>tbody", "MODI", 2);
			String cssId = "#ctl00_cphMainContent_gvProduct>tbody>tr:nth-child("+row+")>td>a";
			safeClick(driver, By.cssSelector(cssId));
	...
	@Test(dataProvider = "ProductGroupList", dependsOnMethods = {"verifyAddNewProducts"})
	public void verifyExportProducts(String item) throws InterruptedException, ErrorPageException {
