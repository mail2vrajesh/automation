...
public class RFQSectionSubHeadingStyles extends ETHOSDomainWraper{
	...
	public void startSelenium() throws Exception {	
		...
		goToPage(new String[]{"System","RFQ Section Heading Styles"});
	}
	
	@Test
	public void verifyHeading() throws Exception
	{
		assertTrue(driver.findElement(By.id("ctl00_lblTitle")).getText().contains("RFQ Section Heading Styles"));
	}
	...
	{
		assertTrue(elementVisible(driver, By.id("ctl00_cphMainContent_gvRFQSectionHeading"), 1));
		assertTrue(elementVisible(driver, By.linkText("Section Heading Style Description"), 1));
	}
	...
	public void verifySelectLink() throws Exception
	{
		...
		assertTrue(driver.findElement(By.id("ctl00_lblTitle")).getText().contains("View RFQ Section Heading Styles"));
	...
	public void verifyAddNewBtn() throws Exception
	{
		...
		assertTrue(driver.findElement(By.id("ctl00_lblTitle")).getText().contains("Add RFQ Section Heading Styles"));
