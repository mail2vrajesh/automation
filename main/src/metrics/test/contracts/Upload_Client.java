...
public class Upload_Client extends MetricsDomainWraper {
	...
	public  void download_Upload_Client() throws Exception{
		...
		DeleteFile(cachedProperties.value("SSUploadClientBlankValid"));
		Downloader(driver, "ctl08_ctl05_lbnBlankClientTemplate");
		String templatcontains=readDataFromXL(cachedProperties.value("SSUploadClientBlankValid"),0,1,1);
		...
		writeTemplateData(1,2,0, "./outputData/"+cachedProperties.value("SSUploadClientBlankValid"));
	...
	public  void importUpload_Client_Valid() throws Exception{
		importXLValid(driver,cachedProperties.value("SSUploadClientBlankValid"));
	...
	@Test (alwaysRun=true,dependsOnMethods={"importUpload_Client_Valid"})
