...
@Test(dataProvider="UserNameInRoles",dependsOnMethods={"verifyTheuserNameinRoleManageMent"})
  ...
  //weShould give avilable rolename
   @DataProvider
	public Object [ ][ ] NameForRoleKey() {
		return new Object [ ] [ ] { {"HelloAdmin"}};
		}
	//Role key MangeMent
	@Test(dataProvider="NameForRoleKey",dependsOnMethods={"CreateUsernameinRollmangement"})
